...
#SBATCH -J RUN_All_A6_sc_eQTL # Job name
...
sbatch --array=$start_gene_id-$end_gene_id RUN_A6_SC_EQTL.sh

#rm -f lst_out_A6.txt
#touch lst_out_A6.txt
#declare -i start_gene_id=0
#declare -i end_gene_id=899
...
#do
#  sbatch --array=$start_gene_id-$end_gene_id RUN_A6_SC_EQTL.sh
#  nb_lines_out_A6=$(wc -l lst_out_A6.txt | awk '{print $1}')
#  while [ $nb_lines_out_A6 -lt $current_uplimit_gene_id ]
#  do
#    sleep 5m
#    ls gene_id*/A6_done.txt > lst_out_A6.txt
#    nb_lines_out_A6=$(wc -l lst_out_A6.txt | awk '{print $1}')
#  done
