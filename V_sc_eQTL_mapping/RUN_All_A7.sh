...
#SBATCH -J RUN_All_A7_sc_eQTL # Job name
...
sbatch --array=$start_gene_id-$end_gene_id RUN_A7_SC_EQTL.sh


#rm -f lst_out_A7.txt
#touch lst_out_A7.txt
#declare -i start_gene_id=0
#declare -i end_gene_id=899
...
#do
#  sbatch --array=$start_gene_id-$end_gene_id RUN_A7_SC_EQTL.sh
#  nb_lines_out_A7=$(wc -l lst_out_A7.txt | awk '{print $1}')
#  while [ $nb_lines_out_A7 -lt $current_uplimit_gene_id ]
#  do
#    sleep 5m
#    ls gene_id*/A7_done.txt > lst_out_A7.txt
#    nb_lines_out_A7=$(wc -l lst_out_A7.txt | awk '{print $1}')
#  done
